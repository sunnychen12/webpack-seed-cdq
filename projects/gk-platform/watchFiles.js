...
wp.watch(['reset.css','reset.less'], [path.resolve(globalJSON.assetsPath,'dist/css')], Date.now() - 10000);

wp.on("change", function(filePath, mtime) {
    fs.writeFileSync( 
         path.join(globalJSON.distPath, 'statics/gkouc/dist/css/reset.less')
      , fs.readFileSync(filePath, "utf8") );

    fs.writeFileSync( 
         path.join(globalJSON.distPath, 'statics/gkouc/dist/css/reset.css')
      , fs.readFileSync(filePath, "utf8") );
});