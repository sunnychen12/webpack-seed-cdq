...
(function (factory) {
  ...
  prototype.load = function (url) {
    ...
    var that=this;
    var cloneImg=$clone.get(0);
    cloneImg.src=bustCacheUrl || url;
    cloneImg.onload=function(){
      var naturalWidth = $(cloneImg).prop('naturalWidth') || $(cloneImg).width(),
          naturalHeight = $(cloneImg).prop('naturalHeight') || $(cloneImg).height();
